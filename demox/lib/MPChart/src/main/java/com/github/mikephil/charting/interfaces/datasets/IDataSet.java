...
public interface IDataSet<T extends Entry> {
    ...
    /**
     * returns average y-value this DataSet holds
     *
     * @return
     */
    float getYAverage();
    ...
    /**
     * Calculates the average y-values from the Entry closest to the given fromX to the Entry closest to the given toX value.
     * This is only needed for the autoScaleMinMax feature.
     */
    void calcAverageY();
     ...
     * @return
     */
    IHighlightValueFormatter getHighlightValueFormatter();
     ...
     * @return
     */
    void setHighlightValueFormatter(IHighlightValueFormatter highlightValueFormatter);
