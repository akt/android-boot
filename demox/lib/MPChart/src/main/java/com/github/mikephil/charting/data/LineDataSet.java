...
import com.github.mikephil.charting.formatter.DefaultHighlightValueFormatter;
...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private float mCircleInnerRadius = 2f;
    ...
    private IHighlightValueFormatter highlightValueFormatter = new DefaultHighlightValueFormatter();
    ...
    private int mAverageLineLabelColor;

    private String mAverageLabelFormat;
    ...
    public DataSet<Entry> copy() {
        ...
        copied.mCircleInnerRadius = mCircleInnerRadius;
    ...
    /**
     * Sets the outer radius of the drawn circles.
     * Default radius = 0.5f, Min = 0.5f
     *
     * @param circleOuterRadius
     */
    public void setCircleInnerRadius(float circleOuterRadius) {
        if (circleOuterRadius >= 0.5f) {
            mCircleInnerRadius = Utils.convertDpToPixel(circleOuterRadius);
        } else {
            Log.e("LineDataSet", "Circle radius cannot be < 0.5");
        }
    }
    ...
    public void setAverageLineLabelColor(int mAverageLineLabelColor) {
        this.mAverageLineLabelColor = mAverageLineLabelColor;
    }
    ...
    @Override
    public String getAverageLabelFormat() {
        return mAverageLabelFormat;
    }

    @Override
    public int getAverageLineLabelColor() {
        return mAverageLineLabelColor;
    }
    ...
    @Override
    public IHighlightValueFormatter getHighlightValueFormatter() {
        return highlightValueFormatter;
    }

    @Override
    public void setHighlightValueFormatter(IHighlightValueFormatter highlightValueFormatter) {
        if (highlightValueFormatter == null)
            this.highlightValueFormatter = new DefaultHighlightValueFormatter();
        else
